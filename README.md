...
应用默认位于 `/Applications/ChatGPT.app`，当前官方 bundle id 为 `com.openai.codex`；脚本也会检查 `~/Applications` 以及 `Codex.app` 名称。所有命令都应在仓库根目录运行。
